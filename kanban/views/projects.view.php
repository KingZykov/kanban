                        ...
                        <div class="ps-content">
                            <ul class=" list-group list-group-flush">
                                ...
                                <?php if (isset($projects)) {	
                                    ...
                                    ?>                         
                                    <li class="accordion list-group-item pe-auto" id="project-p-<?php echo $i; ?>" draggable=false>        
		...
		<div class="menu container">
			...
			<div id="navbarSupportedContent" class="collapse navbar-collapse">
				<ul class="navbar-nav  ml-auto">
					...
					<li class="mynav5"><a href="/login/logout.php" class="hbtn ">Выйти</a></li>				
				</ul>
			</div>
                                    ...
                                    <div class="card-hover-shadow-2x mb-3 card text-dark">
                                        ...
                                        <div class="scroll-area-sm">
                                            <perfect-scrollbar class="ps-show-limits">
                                                <div style="position: static;" class="ps ps--active-y">
                                                    <div class="ps-content">
                                                        <ul class=" list-group list-group-flush" id="col1">                                                          
                                                        ...
                                                        <?php if (isset($show_tasks)) {	
                                                            ...
                                                            foreach ($show_tasks as $s): 
                                                                if($s['task_status'] == '1'){
                                                        ?>  
                                                            <li class="accordion list-group-item pe-auto" id="task-todo-<?php echo $i; ?>" draggable="false">                                                                      
                                    ...
                                    <div class="card-hover-shadow-2x mb-3 card text-dark">
                                        ...
                                        <div class="scroll-area-sm">
                                            <perfect-scrollbar class="ps-show-limits">
                                                <div style="position: static;" class="ps ps--active-y">
                                                    <div class="ps-content">
                                                        <ul class=" list-group list-group-flush" id="col2">
                                                        ...
                                                        <li class="accordion list-group-item pe-auto" id="task-ip-<?php echo $i; ?>" draggable="false">        
                                                                <div class="todo-indicator" style="background-color:<?php echo $s['task_color'];?>;">
                                                                </div>
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                    ...
                                    <div class="card-hover-shadow-2x mb-3 card text-dark">
                                        ...
                                        <div class="scroll-area-sm">
                                            <perfect-scrollbar class="ps-show-limits">
                                                <div style="position: static;" class="ps ps--active-y">
                                                    <div class="ps-content">
                                                        <ul class=" list-group list-group-flush" id="col3"> 
                                                        <?php if (isset($show_tasks)) {	
                                                            $i = 2000000;
                                                            foreach ($show_tasks as $s): 
                                                                if($s['task_status'] == '3'){
                                                        ?>  
                                                            ...
                                                            <li class="accordion list-group-item pe-auto" id="task-c-<?php echo $i; ?>" draggable="false">        
                                                                <div class="todo-indicator" style="background-color:<?php echo $s['task_color'];?>;">
                                                                </div>
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
...
<!--<script src=/js/drag_and_drop.js.js> </script>-->
</body>
</html>
